...
function createMarkdown(options) {
  ...
  return (id, raw) => {
    ...
    const { content: md, data } = options.frontmatter ? (0, import_gray_matter.default)(raw) : { content: raw, data: null };
...
function resolveOptions(userOptions) {
  ...
  (_a = options.vueVersion) != null ? _a : options.vueVersion = getVueVersion();
  return options;
}
